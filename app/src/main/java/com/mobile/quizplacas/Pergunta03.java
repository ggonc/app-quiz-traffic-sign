...
public class Pergunta03 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textNumeroPergunta.setText("3/3");
    ...
    public void responder(View view){
        ...
        if (radioButton.getText().equals("Proibido retornar à esquerda")){
            acertos += 1;
        }

        Intent fimDeJogo = new Intent(this, FimDeJogo.class);
        fimDeJogo.putExtra("acertos", acertos);
